#pragma once
// 교환 사슬
// [외주 과정] 현재 게임 세상에 있는 상황을 묘사: 목적
// 1. 어떤 공식으로 어떻게 계산할지 던져줌
// 2. GPU가 열심히 계산 (외주)
// 3. 결과물 받아서 화면에 그려준다
...
// SO...
// - 특수 종이(buffer)를 2개 만들어서, 하나는 현재 화면을 그려주고, 하나는 외주 맡기고(계속 왔다갔다)
// - Double Buffering!
...
private:
	...
	//render: 그리다 tartget: 목적
	//SWAP_CHAIN_BUFFER_COUNT 위에 이게 들어가는데 귀찮으니까 engine.h에 enum을 만들자~!!
	uint32										_backBufferIndex = 0;
	//현재 뒷작업을 하고 있는 index -> 0,1,0,1 로 바뀔꺼임.
