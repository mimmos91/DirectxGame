...
void ConstantBuffer::Init(uint32 size, uint32 count)
{
	...
	// 0 256 512 768
	_elementSize = (size + 255) & ~255; // 보정해주는 것 255 = 1111 1111(2) & ~255 =(0000 0000) -> 하위 8bit를 0으로 초기화
	_elementCount = count;
...
{
	uint32 bufferSize = _elementSize * _elementCount; //큰 영역 할당
...
{
	assert(_currentIndex < _elementSize); // 디버깅 코드로 버퍼크기가 벗어나면 crash를 냄.
